 ...
 * 
 * public static class Pos로 좌표 클래스 설정
 * 0의 위치도 이차원배열 맵 받을 때 같이 리스트로 받자
 * 0의 개수도 전체 height*width에서 벽+바이러스 퍼진거 개수를 뺀만큼으로 해서 전체 순회안하게 고쳐보자
 */
...
//		queue = new ArrayDeque<>(virusList);
		...
		//여기서 0 빈칸으로 선택할 수 있는 것과, virus 인걸로 나눠서 list에 넣어주기
